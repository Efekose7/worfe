...
export const WEATHER_CODES = {
  0: { description: 'Clear sky', icon: '☀️', color: '#FFD60A' },
  1: { description: 'Mainly clear', icon: '🌤️', color: '#FFD60A' },
  2: { description: 'Partly cloudy', icon: '⛅', color: '#8D99AE' },
  3: { description: 'Overcast', icon: '☁️', color: '#8D99AE' },
  45: { description: 'Fog', icon: '🌫️', color: '#8D99AE' },
  48: { description: 'Depositing rime fog', icon: '🌫️', color: '#8D99AE' },
  51: { description: 'Light drizzle', icon: '🌦️', color: '#4CC9F0' },
  53: { description: 'Moderate drizzle', icon: '🌦️', color: '#4CC9F0' },
  55: { description: 'Dense drizzle', icon: '🌦️', color: '#4CC9F0' },
  56: { description: 'Light freezing drizzle', icon: '🌨️', color: '#4CC9F0' },
  57: { description: 'Dense freezing drizzle', icon: '🌨️', color: '#4CC9F0' },
  61: { description: 'Slight rain', icon: '🌧️', color: '#4CC9F0' },
  63: { description: 'Moderate rain', icon: '🌧️', color: '#4CC9F0' },
  65: { description: 'Heavy rain', icon: '🌧️', color: '#4CC9F0' },
  66: { description: 'Light freezing rain', icon: '🌨️', color: '#4CC9F0' },
  67: { description: 'Heavy freezing rain', icon: '🌨️', color: '#4CC9F0' },
  71: { description: 'Slight snow fall', icon: '❄️', color: '#FFFFFF' },
  73: { description: 'Moderate snow fall', icon: '❄️', color: '#FFFFFF' },
  75: { description: 'Heavy snow fall', icon: '❄️', color: '#FFFFFF' },
  77: { description: 'Snow grains', icon: '❄️', color: '#FFFFFF' },
  80: { description: 'Slight rain showers', icon: '🌦️', color: '#4CC9F0' },
  81: { description: 'Moderate rain showers', icon: '🌦️', color: '#4CC9F0' },
  82: { description: 'Violent rain showers', icon: '🌧️', color: '#4CC9F0' },
  85: { description: 'Slight snow showers', icon: '🌨️', color: '#FFFFFF' },
  86: { description: 'Heavy snow showers', icon: '🌨️', color: '#FFFFFF' },
  95: { description: 'Thunderstorm', icon: '⛈️', color: '#7209B7' },
  96: { description: 'Thunderstorm with slight hail', icon: '⛈️', color: '#7209B7' },
  99: { description: 'Thunderstorm with heavy hail', icon: '⛈️', color: '#7209B7' }
};
