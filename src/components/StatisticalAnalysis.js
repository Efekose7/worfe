...
const StatisticalAnalysis = ({ statisticalData, eventType, isLoading }) => {
  if (isLoading) {
    return (
      <div className="card p-6">
        <div className="text-center py-8">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-earth-cyan mx-auto mb-4"></div>
          <h3 className="text-lg font-semibold text-white mb-2">Analyzing Historical Data</h3>
          <p className="text-gray-400">Processing 20+ years of NASA weather data...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="card p-6">
        <div className="text-center py-8">
          ...
          <p className="text-gray-400">Not enough historical data available for statistical analysis</p>
        </div>
      </div>
    );
  }
