# Worfe - Event Weather Planning Dashboard

🌐 **Live Site**: [worfe.vip](https://worfe.vip)

![Worfe Weather Dashboard](https://img.shields.io/badge/Worfe-Event%20Weather%20Planning-blue?style=for-the-badge&logo=weather)
![React](https://img.shields.io/badge/React-18.2.0-blue?style=for-the-badge&logo=react)
![Tailwind CSS](https://img.shields.io/badge/Tailwind%20CSS-3.3.0-blue?style=for-the-badge&logo=tailwindcss)
![NASA](https://img.shields.io/badge/NASA-Earth%20Observation-red?style=for-the-badge&logo=nasa)

**"Will It Rain On My Parade?"** - Worfe is a NASA Earth observation data-powered event weather planning platform that helps you plan outdoor events with confidence. Using NASA POWER API and advanced statistical analysis, it provides risk scores and alternative date suggestions for weddings, concerts, sports events, and more.

## 🌟 Features

### 🎉 Event Planning Focus
- **5 Event Types**: Wedding, Concert, Sports, Picnic, Parade
- **Risk Scoring**: Event-specific weather risk analysis
- **Alternative Dates**: AI-powered date suggestions
- **Real-time Analysis**: Current weather + historical patterns

### Core Functionality
- **Interactive Map Selection**: Click to drop pins or search for locations worldwide
- **Event Type Selection**: Choose from 5 specialized event types
